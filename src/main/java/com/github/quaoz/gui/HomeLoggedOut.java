...
// DO NOT EDIT OR ADD ANY CODE HERE!
	...
	private void $$$setupUI$$$() {
		panel = new JPanel();
		panel.setLayout(new FormLayout("fill:d:grow,left:4dlu:noGrow,fill:d:grow,left:4dlu:noGrow,fill:max(d;4px):noGrow,left:4dlu:noGrow,fill:max(d;4px):noGrow,left:4dlu:noGrow,fill:max(d;4px):noGrow,left:4dlu:noGrow,fill:d:grow", "center:max(d;4px):noGrow,top:3dlu:noGrow,center:d:noGrow"));
		...
		panel.add(signInButton, cc.xy(7, 3));
		signUpButton = new JButton();
		this.$$$loadButtonText$$$(signUpButton, this.$$$getMessageFromBundle$$$("ia", "sign.up"));
		panel.add(signUpButton, cc.xy(9, 3));
		final Spacer spacer1 = new Spacer();
		panel.add(spacer1, cc.xy(11, 3, CellConstraints.FILL, CellConstraints.DEFAULT));
		final Spacer spacer2 = new Spacer();
		panel.add(spacer2, cc.xy(1, 3, CellConstraints.FILL, CellConstraints.DEFAULT));
