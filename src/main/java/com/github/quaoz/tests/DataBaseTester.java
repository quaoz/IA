...
public static void main(String[] args) {
	...
	try (DataBase dataBase = new DataBase(databaseFile.toPath(), configFile.toPath(), config)) {
	...
	System.out.println(Arrays.toString(dataBase.collect("2sad", 1).toArray()));
	System.out.println(Arrays.toString(dataBase.collect("0aaa", 1).toArray()));
	System.out.println(Arrays.toString(dataBase.collect("4gwe", 1).toArray()));
	System.out.println(Arrays.toString(dataBase.collect("8aaa", 1).toArray()));
	System.out.println(dataBase.getRecordCount());

	System.out.println(Arrays.toString(dataBase.collect("1sad", 1, 4).toArray()));
	} catch (IOException e) {
	e.printStackTrace();
	}
